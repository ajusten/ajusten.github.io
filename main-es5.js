(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DataComponent = /** @class */ (function () {
                function DataComponent(route, service) {
                    this.route = route;
                    this.service = service;
                }
                DataComponent.prototype.getFormEntries = function (goalId, formId) {
                    this.state = this.service.getState(goalId);
                    var entries = this.service.getFormEntries(goalId, formId);
                    return Object.keys(entries).map(function (k) { return ({
                        id: k,
                        data: entries[k]
                    }); });
                };
                DataComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.parent.data.subscribe(function (data) {
                        _this.goalId = _this.route.parent.snapshot.params.goalId;
                        _this.goal = _this.service.get(_this.goalId);
                        _this.forms = Object.keys(_this.goal.forms).map(function (k) { return ({
                            id: k,
                            entries: _this.getFormEntries(_this.goalId, k)
                        }); });
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FormComponent = /** @class */ (function () {
                function FormComponent(route, service) {
                    this.route = route;
                    this.service = service;
                }
                FormComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.parent.data.subscribe(function (data) {
                        var goalId = _this.route.parent.snapshot.params.goalId;
                        var formId = _this.route.snapshot.params.formId;
                        var entryId = _this.route.snapshot.params.entryId;
                        _this.form = _this.service.getForm(goalId, formId, entryId);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GetstartedComponent = /** @class */ (function () {
                function GetstartedComponent(route, service) {
                    this.route = route;
                    this.service = service;
                }
                GetstartedComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.parent.data.subscribe(function (data) {
                        var goalId = _this.route.parent.snapshot.params.goalId;
                        _this.steps = _this.service.getSteps(goalId);
                    });
                };
            ...
            var GoalsComponent = /** @class */ (function () {
                ...
                GoalsComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.data.subscribe(function (data) {
                        ...
                        var goalId = _this.route.snapshot.params.goalId;
                        _this.links = [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StepsComponent = /** @class */ (function () {
                function StepsComponent(route, service) {
                    this.route = route;
                    this.service = service;
                }
                StepsComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.parent.data.subscribe(function (data) {
                        var goalId = _this.route.parent.snapshot.params.goalId;
                        _this.currentStep = _this.service.getNextStep(goalId);
                    });
                };
                StepsComponent.prototype.onSubmit = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GoalsService = /** @class */ (function () {
                function GoalsService(repo, notification) {
                    this.repo = repo;
                    this.notification = notification;
                }
                GoalsService.prototype.advanceStep = function (step) {
                ...
                GoalsService.prototype.getState = function (goalId) {
                    return this.repo.getEntry("" + goalId, 'state') || {};
                };
                GoalsService.prototype.saveState = function (goalId, state) {
                    return this.repo.saveEntry("" + goalId, 'state', state);
                };
                GoalsService.prototype.getNextStep = function (goalId) {
                ...
                GoalsService.prototype.getStep = function (goalId, goal, stepName) {
                    var step = Object.assign({}, goal.steps[stepName], { goalId: goalId, id: stepName });
                    if (step.type === 'form') {
                        step.form = this.getForm(goalId, step.form, null);
                    }
                    else if (step.type === 'reminder') {
                        var base = 'http://www.google.com/calendar/event';
                        var start = '20191031T130000Z';
                        var end = '20191031T140000Z';
                        var title = '';
                        var location = '';
                        var body = '';
                        var url = base + "?action=TEMPLATE&dates=" + start + "%2F" + end + "&text=" + title + "&location=" + location + "&details=" + body;
                        step.googleCalendar = url;
                    }
                    return step;
                };
                GoalsService.prototype.getSteps = function (goalId) {
                    var goal = this.get(goalId);
                    var steps = [];
                    var nextStep = 'start';
                    var index = 0;
                ...
                GoalsService.prototype.saveForm = function (goalId, formId, entryId, data) {
                    this.repo.saveEntry(goalId + "/forms/" + formId, entryId, data);
                    this.notification.info("Saved successfully");
                };
                GoalsService.prototype.getFormCurrent = function (goalId, formId) {
                    return this.getForm(goalId, formId, null);
                };
                GoalsService.prototype.getFormEntry = function (scope) {
                    switch (scope) {
                ...
                GoalsService.prototype.getFormEntries = function (goalId, formId) {
                    var entries = this.repo.getEntries(goalId + "/forms/" + formId);
                    return entries;
                };
                GoalsService.prototype.getForm = function (goalId, formId, entryId) {
                    var goal = this.get(goalId);
                ...
                GoalsService.prototype.getAllGoals = function () {
                    var allGoals = [calorieCount, readBook];
                    return allGoals.map(function (g) { return ({
                        title: g.title,
                        icon: g.icon,
                        id: g.id,
                ...
                GoalsService.prototype.get = function (id) {
                    switch (id) {
            ...
            GoalsService.ctorParameters = function () { return [
            ...
            var GoalResolver = /** @class */ (function () {
                function GoalResolver(service) {
                    this.service = service;
                }
                GoalResolver.prototype.resolve = function (route, state) {
                    return this.service.get(route.paramMap.get('goalId'));
                };
                return GoalResolver;
            }());
            GoalResolver.ctorParameters = function () { return [
                { type: GoalsService }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NotificationService = /** @class */ (function () {
                function NotificationService(_snackBar) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RepositoryService = /** @class */ (function () {
                function RepositoryService(storage) {
                ...
                RepositoryService.prototype.saveRepository = function (repositoryId) {
                    var repo = this.getRepository(repositoryId);
                    return this.storage.set("repositories/" + repositoryId, repo);
                };
                RepositoryService.prototype.getEntries = function (repositoryId) {
                    return this.getRepository(repositoryId);
                };
                RepositoryService.prototype.getEntry = function (repositoryId, entryId) {
                    var repo = this.getRepository(repositoryId);
                    return repo[entryId];
                };
                RepositoryService.prototype.saveEntry = function (repositoryId, entryId, data) {
                    var repo = this.getRepository(repositoryId);
                    repo[entryId] = data;
